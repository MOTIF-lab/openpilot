...
class RouteEngine:
  ...
  def calculate_route(self, destination):
    ...
    try:
      ...
      ##66, we can modify the r generated by mapbox using LLM or more traffic information? 
      ## possibly create a AdvisoryRoute(r) function to improve the mapbox output
